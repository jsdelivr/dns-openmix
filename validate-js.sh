...
echo
java -jar test/compiler.jar --js app.js --js test/openmix-externs.js --compilation_level ADVANCED --js_output_file /dev/null --warning_level VERBOSE --language_in ECMASCRIPT5
echo -e "${no_color}"
